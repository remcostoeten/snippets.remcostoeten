...
export function Hero() {
    return (
        <div className="mx-auto max-w-3xl text-center">
            ...
            <OptimizedTextAnimate animation="blurInUp" className="mb-8" fontSize="lg" textColor="zinc-400" delay={0.4}>
                A collection of reusable code snippets, notes, and documentation for web development with subjects like
                (git)-tooling, database helpers, work snippets or reusable code.
            </OptimizedTextAnimate>
            <motion.div
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
