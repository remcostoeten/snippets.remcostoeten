    ...
    return (
        <div className="mx-auto max-w-3xl text-center">
            ...
            >
                ...
                >
                    <ShinyBadge className="inline-flex items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
                        <span>
                            <span className="animate-pulse duration-500">✨</span> Personal Code Snippets & Notes
                        </span>
            ...
            <OptimizedTextAnimate
                ...
                delay={0.1}
            >
                <GradientText variant="subtle">Nothing really to see here</GradientText>
            </OptimizedTextAnimate>

            <OptimizedTextAnimate animation="blurInUp" className="mb-8" fontSize="lg" textColor="zinc-400" delay={0.2}>
                A collection of reusable code snippets, notes, and documentation for web development with subjects like
                (git)-tooling, database helpers, work snippets or reusable code. Mostly because I like writing and can't
            ...
            >
                <Link href="/docs">
                    <Button className="bg-zinc-800 hover:bg-zinc-700 text-zinc-100">Browse Documentation</Button>
                </Link>
                <div className="relative w-full max-w-sm">
                    <Search variant="header" placeholder="Search..." className="max-w-[200px] md:max-w-xs" />
                </div>
            </motion.div>
        </div>
    )
