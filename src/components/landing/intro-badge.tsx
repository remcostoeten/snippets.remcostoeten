	...
	return (
		<div className='mx-auto max-w-3xl text-center'>
			...
			>
				...
				for web development with subjects like (git)-tooling, database
				helpers, work snippets or reusable code. Mostly because I like
				writing and can't remember the things I learned.
			</OptimizedTextAnimate>
			<motion.div
				initial={{ opacity: 0, y: 10 }}
				animate={{ opacity: 1, y: 0 }}
