...
export const TextWrappersDemo = () => (
	<div className='space-y-6 p-4 bg-gray-50 rounded-lg'>
		...
		<section className='space-y-2'>
			...
			<p>
				<Pulse>Pulsing text</Pulse> - Draws attention with subtle
				animation
			</p>
			<p>
		...
		<section className='space-y-2'>
			...
			<p>
				<WithEmoji emojiCategory='frontend'>
					Frontend development
				</WithEmoji>
			</p>
			<p>
				<WithEmoji emojiCategory='backend'>
					Backend development
				</WithEmoji>
			</p>
			<p>
				<WithEmoji emojiCategory='database'>
					Database concepts
				</WithEmoji>
			</p>
		</section>
		...
		<section className='space-y-2'>
			...
			<p>
				<CodeNote>
					Code notes stand out with code-related emojis
				</CodeNote>
			</p>
			<p>
