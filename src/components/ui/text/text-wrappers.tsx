...
export const CodeNote = ({ children, className, emojiIndex = 0 }: TProps) => (
  <WithEmoji
    ...
    className={cn("text-blue-600 bg-blue-50 px-2 py-1 rounded", className)}
  >
    <B>{children}</B>
  </WithEmoji>
);
...
export const Tip = ({ children, className, emojiIndex = 0 }: TProps) => (
  <WithEmoji
    emojiCategory="tip"
    emojiIndex={emojiIndex}
    className={cn("text-green-600 bg-green-50 px-2 py-1 rounded", className)}
  >
    {children}
  </WithEmoji>
);
...
export const Warning = ({ children, className, emojiIndex = 0 }: TProps) => (
  <WithEmoji
    emojiCategory="warning"
    emojiIndex={emojiIndex}
    className={cn("text-amber-600 bg-amber-50 px-2 py-1 rounded", className)}
  >
    <B>{children}</B>
  </WithEmoji>
);
...
export const Important = ({ children, className, emojiIndex = 0 }: TProps) => (
  <WithEmoji
    emojiCategory="important"
    emojiIndex={emojiIndex}
    className={cn("text-red-600 bg-red-50 px-2 py-1 rounded", className)}
  >
    <B>{children}</B>
  </WithEmoji>
);
...
export const Example = ({ children, className, emojiIndex = 0 }: TProps) => (
  <WithEmoji
    emojiCategory="example"
    emojiIndex={emojiIndex}
    className={cn("text-purple-600 bg-purple-50 px-2 py-1 rounded", className)}
  >
    {children}
  </WithEmoji>
);

// Web Development Domain Specific Components
export const Frontend = ({ children, className, emojiIndex = 0 }: TProps) => (
  <WithEmoji
    emojiCategory="frontend"
    emojiIndex={emojiIndex}
