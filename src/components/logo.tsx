...
const LogoIcon = () => {
    ...
    return (
        ...
        >
            ...
            >
                <motion.circle cx="16" cy="2" r="1.5" className="fill-primary" variants={circleVariants} />
                <motion.circle cx="28" cy="9" r="1.5" className="fill-primary" variants={circleVariants} />
                <motion.circle cx="28" cy="23" r="1.5" className="fill-primary" variants={circleVariants} />
                <motion.circle cx="16" cy="30" r="1.5" className="fill-primary" variants={circleVariants} />
                <motion.circle cx="4" cy="23" r="1.5" className="fill-primary" variants={circleVariants} />
                <motion.circle cx="4" cy="9" r="1.5" className="fill-primary" variants={circleVariants} />
            </motion.g>
        </motion.svg>
    )
}
