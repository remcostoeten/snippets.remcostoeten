...
alias runsite="cd ~/sites && cd remco-tools && code . &&  git pull &&  pnpm run dev"
alias gor="cd ~/sites/remco-tools"
alias run="code .  &&  git pull &&  pnpm run dev"
